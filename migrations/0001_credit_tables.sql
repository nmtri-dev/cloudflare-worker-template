...
CREATE UNIQUE INDEX IF NOT EXISTS idx_monthly_account_unique ON credit_accounts (user_id, effective_from, expired_at)
WHERE
  type = 'monthly';

CREATE UNIQUE INDEX IF NOT EXISTS idx_permanent_account_unique ON credit_accounts (user_id)
WHERE
  type = 'permanent';
